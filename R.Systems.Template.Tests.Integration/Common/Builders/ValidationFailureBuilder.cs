...
internal static class ValidationFailureBuilder
{
        ...
        string? fieldNameInMsg = null)
    {
        ...
        {
            PropertyName = $"{fieldName}",
            ErrorMessage = $"The length of '{fieldNameInMsg}' must be {maxLength} characters or fewer. You entered {maxLength + 1} characters.",
        ...
        string? fieldNameInMsg = null)
    {
        ...
        {
            PropertyName = $"{fieldName}",
            ErrorMessage = $"'{fieldNameInMsg}' must be {expectedLength} characters in length. You entered {enteredLength} characters.",
            ErrorCode = ""
        };
    }
